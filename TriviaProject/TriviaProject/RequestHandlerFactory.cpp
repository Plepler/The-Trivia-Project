...
RoomMemberRequestHandler* RequestHandlerFactory::createRoomMemberRequestHandler(Room* room, LoggedUser* loggedUser)
{
	return new RoomMemberRequestHandler(room, loggedUser, this);
}
